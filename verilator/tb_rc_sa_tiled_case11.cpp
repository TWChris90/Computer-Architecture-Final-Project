...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case11";
  ...
  if ((int)inVec.size() != (int)147) {
    std::cerr << "input length mismatch vs pin count: " << inVec.size() << " vs " << 147 << "\n";
    return 1;
  }
  ...
  dut->io_x_in_1_0 = (int)inVec[49];
  dut->io_x_in_1_1 = (int)inVec[50];
  dut->io_x_in_1_2 = (int)inVec[51];
  dut->io_x_in_1_3 = (int)inVec[52];
  dut->io_x_in_1_4 = (int)inVec[53];
  dut->io_x_in_1_5 = (int)inVec[54];
  dut->io_x_in_1_6 = (int)inVec[55];
  dut->io_x_in_1_7 = (int)inVec[56];
  dut->io_x_in_1_8 = (int)inVec[57];
  dut->io_x_in_1_9 = (int)inVec[58];
  dut->io_x_in_1_10 = (int)inVec[59];
  dut->io_x_in_1_11 = (int)inVec[60];
  dut->io_x_in_1_12 = (int)inVec[61];
  dut->io_x_in_1_13 = (int)inVec[62];
  dut->io_x_in_1_14 = (int)inVec[63];
  dut->io_x_in_1_15 = (int)inVec[64];
  dut->io_x_in_1_16 = (int)inVec[65];
  dut->io_x_in_1_17 = (int)inVec[66];
  dut->io_x_in_1_18 = (int)inVec[67];
  dut->io_x_in_1_19 = (int)inVec[68];
  dut->io_x_in_1_20 = (int)inVec[69];
  dut->io_x_in_1_21 = (int)inVec[70];
  dut->io_x_in_1_22 = (int)inVec[71];
  dut->io_x_in_1_23 = (int)inVec[72];
  dut->io_x_in_1_24 = (int)inVec[73];
  dut->io_x_in_1_25 = (int)inVec[74];
  dut->io_x_in_1_26 = (int)inVec[75];
  dut->io_x_in_1_27 = (int)inVec[76];
  dut->io_x_in_1_28 = (int)inVec[77];
  dut->io_x_in_1_29 = (int)inVec[78];
  dut->io_x_in_1_30 = (int)inVec[79];
  dut->io_x_in_1_31 = (int)inVec[80];
  dut->io_x_in_1_32 = (int)inVec[81];
  dut->io_x_in_1_33 = (int)inVec[82];
  dut->io_x_in_1_34 = (int)inVec[83];
  dut->io_x_in_1_35 = (int)inVec[84];
  dut->io_x_in_1_36 = (int)inVec[85];
  dut->io_x_in_1_37 = (int)inVec[86];
  dut->io_x_in_1_38 = (int)inVec[87];
  dut->io_x_in_1_39 = (int)inVec[88];
  dut->io_x_in_1_40 = (int)inVec[89];
  dut->io_x_in_1_41 = (int)inVec[90];
  dut->io_x_in_1_42 = (int)inVec[91];
  dut->io_x_in_1_43 = (int)inVec[92];
  dut->io_x_in_1_44 = (int)inVec[93];
  dut->io_x_in_1_45 = (int)inVec[94];
  dut->io_x_in_1_46 = (int)inVec[95];
  dut->io_x_in_1_47 = (int)inVec[96];
  dut->io_x_in_1_48 = (int)inVec[97];
  dut->io_x_in_2_0 = (int)inVec[98];
  dut->io_x_in_2_1 = (int)inVec[99];
  dut->io_x_in_2_2 = (int)inVec[100];
  dut->io_x_in_2_3 = (int)inVec[101];
  dut->io_x_in_2_4 = (int)inVec[102];
  dut->io_x_in_2_5 = (int)inVec[103];
  dut->io_x_in_2_6 = (int)inVec[104];
  dut->io_x_in_2_7 = (int)inVec[105];
  dut->io_x_in_2_8 = (int)inVec[106];
  dut->io_x_in_2_9 = (int)inVec[107];
  dut->io_x_in_2_10 = (int)inVec[108];
  dut->io_x_in_2_11 = (int)inVec[109];
  dut->io_x_in_2_12 = (int)inVec[110];
  dut->io_x_in_2_13 = (int)inVec[111];
  dut->io_x_in_2_14 = (int)inVec[112];
  dut->io_x_in_2_15 = (int)inVec[113];
  dut->io_x_in_2_16 = (int)inVec[114];
  dut->io_x_in_2_17 = (int)inVec[115];
  dut->io_x_in_2_18 = (int)inVec[116];
  dut->io_x_in_2_19 = (int)inVec[117];
  dut->io_x_in_2_20 = (int)inVec[118];
  dut->io_x_in_2_21 = (int)inVec[119];
  dut->io_x_in_2_22 = (int)inVec[120];
  dut->io_x_in_2_23 = (int)inVec[121];
  dut->io_x_in_2_24 = (int)inVec[122];
  dut->io_x_in_2_25 = (int)inVec[123];
  dut->io_x_in_2_26 = (int)inVec[124];
  dut->io_x_in_2_27 = (int)inVec[125];
  dut->io_x_in_2_28 = (int)inVec[126];
  dut->io_x_in_2_29 = (int)inVec[127];
  dut->io_x_in_2_30 = (int)inVec[128];
  dut->io_x_in_2_31 = (int)inVec[129];
  dut->io_x_in_2_32 = (int)inVec[130];
  dut->io_x_in_2_33 = (int)inVec[131];
  dut->io_x_in_2_34 = (int)inVec[132];
  dut->io_x_in_2_35 = (int)inVec[133];
  dut->io_x_in_2_36 = (int)inVec[134];
  dut->io_x_in_2_37 = (int)inVec[135];
  dut->io_x_in_2_38 = (int)inVec[136];
  dut->io_x_in_2_39 = (int)inVec[137];
  dut->io_x_in_2_40 = (int)inVec[138];
  dut->io_x_in_2_41 = (int)inVec[139];
  dut->io_x_in_2_42 = (int)inVec[140];
  dut->io_x_in_2_43 = (int)inVec[141];
  dut->io_x_in_2_44 = (int)inVec[142];
  dut->io_x_in_2_45 = (int)inVec[143];
  dut->io_x_in_2_46 = (int)inVec[144];
  dut->io_x_in_2_47 = (int)inVec[145];
  dut->io_x_in_2_48 = (int)inVec[146];

  if ((int)wVec.size() != (int)54) {
    std::cerr << "weight length mismatch vs pin count: " << wVec.size() << " vs " << 54 << "\n";
    return 1;
  }
  ...
  dut->io_w_in_1_0 = (int)wVec[27];
  dut->io_w_in_1_1 = (int)wVec[28];
  dut->io_w_in_1_2 = (int)wVec[29];
  dut->io_w_in_1_3 = (int)wVec[30];
  dut->io_w_in_1_4 = (int)wVec[31];
  dut->io_w_in_1_5 = (int)wVec[32];
  dut->io_w_in_1_6 = (int)wVec[33];
  dut->io_w_in_1_7 = (int)wVec[34];
  dut->io_w_in_1_8 = (int)wVec[35];
  dut->io_w_in_1_9 = (int)wVec[36];
  dut->io_w_in_1_10 = (int)wVec[37];
  dut->io_w_in_1_11 = (int)wVec[38];
  dut->io_w_in_1_12 = (int)wVec[39];
  dut->io_w_in_1_13 = (int)wVec[40];
  dut->io_w_in_1_14 = (int)wVec[41];
  dut->io_w_in_1_15 = (int)wVec[42];
  dut->io_w_in_1_16 = (int)wVec[43];
  dut->io_w_in_1_17 = (int)wVec[44];
  dut->io_w_in_1_18 = (int)wVec[45];
  dut->io_w_in_1_19 = (int)wVec[46];
  dut->io_w_in_1_20 = (int)wVec[47];
  dut->io_w_in_1_21 = (int)wVec[48];
  dut->io_w_in_1_22 = (int)wVec[49];
  dut->io_w_in_1_23 = (int)wVec[50];
  dut->io_w_in_1_24 = (int)wVec[51];
  dut->io_w_in_1_25 = (int)wVec[52];
  dut->io_w_in_1_26 = (int)wVec[53];
  ...
  std::cout << "[case11] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
