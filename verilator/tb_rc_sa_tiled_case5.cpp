...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case5";
  ...
  if ((int)inVec.size() != (int)72) {
    std::cerr << "input length mismatch vs pin count: " << inVec.size() << " vs " << 72 << "\n";
    return 1;
  }
  ...
  dut->io_w_in_3_0 = (int)wVec[54];
  dut->io_w_in_3_1 = (int)wVec[55];
  dut->io_w_in_3_2 = (int)wVec[56];
  dut->io_w_in_3_3 = (int)wVec[57];
  dut->io_w_in_3_4 = (int)wVec[58];
  dut->io_w_in_3_5 = (int)wVec[59];
  dut->io_w_in_3_6 = (int)wVec[60];
  dut->io_w_in_3_7 = (int)wVec[61];
  dut->io_w_in_3_8 = (int)wVec[62];
  dut->io_w_in_3_9 = (int)wVec[63];
  dut->io_w_in_3_10 = (int)wVec[64];
  dut->io_w_in_3_11 = (int)wVec[65];
  dut->io_w_in_3_12 = (int)wVec[66];
  dut->io_w_in_3_13 = (int)wVec[67];
  dut->io_w_in_3_14 = (int)wVec[68];
  dut->io_w_in_3_15 = (int)wVec[69];
  dut->io_w_in_3_16 = (int)wVec[70];
  dut->io_w_in_3_17 = (int)wVec[71];
  ...
  std::cout << "[case5] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
