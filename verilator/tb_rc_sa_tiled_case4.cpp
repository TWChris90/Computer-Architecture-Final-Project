...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case4";
  ...
  if ((int)inVec.size() != (int)75) {
    std::cerr << "input length mismatch vs pin count: " << inVec.size() << " vs " << 75 << "\n";
    return 1;
  }
  ...
  if ((int)wVec.size() != (int)108) {
    std::cerr << "weight length mismatch vs pin count: " << wVec.size() << " vs " << 108 << "\n";
    return 1;
  }
  ...
  dut->io_w_in_2_0 = (int)wVec[54];
  dut->io_w_in_2_1 = (int)wVec[55];
  dut->io_w_in_2_2 = (int)wVec[56];
  dut->io_w_in_2_3 = (int)wVec[57];
  dut->io_w_in_2_4 = (int)wVec[58];
  dut->io_w_in_2_5 = (int)wVec[59];
  dut->io_w_in_2_6 = (int)wVec[60];
  dut->io_w_in_2_7 = (int)wVec[61];
  dut->io_w_in_2_8 = (int)wVec[62];
  dut->io_w_in_2_9 = (int)wVec[63];
  dut->io_w_in_2_10 = (int)wVec[64];
  dut->io_w_in_2_11 = (int)wVec[65];
  dut->io_w_in_2_12 = (int)wVec[66];
  dut->io_w_in_2_13 = (int)wVec[67];
  dut->io_w_in_2_14 = (int)wVec[68];
  dut->io_w_in_2_15 = (int)wVec[69];
  dut->io_w_in_2_16 = (int)wVec[70];
  dut->io_w_in_2_17 = (int)wVec[71];
  dut->io_w_in_2_18 = (int)wVec[72];
  dut->io_w_in_2_19 = (int)wVec[73];
  dut->io_w_in_2_20 = (int)wVec[74];
  dut->io_w_in_2_21 = (int)wVec[75];
  dut->io_w_in_2_22 = (int)wVec[76];
  dut->io_w_in_2_23 = (int)wVec[77];
  dut->io_w_in_2_24 = (int)wVec[78];
  dut->io_w_in_2_25 = (int)wVec[79];
  dut->io_w_in_2_26 = (int)wVec[80];
  dut->io_w_in_3_0 = (int)wVec[81];
  dut->io_w_in_3_1 = (int)wVec[82];
  dut->io_w_in_3_2 = (int)wVec[83];
  dut->io_w_in_3_3 = (int)wVec[84];
  dut->io_w_in_3_4 = (int)wVec[85];
  dut->io_w_in_3_5 = (int)wVec[86];
  dut->io_w_in_3_6 = (int)wVec[87];
  dut->io_w_in_3_7 = (int)wVec[88];
  dut->io_w_in_3_8 = (int)wVec[89];
  dut->io_w_in_3_9 = (int)wVec[90];
  dut->io_w_in_3_10 = (int)wVec[91];
  dut->io_w_in_3_11 = (int)wVec[92];
  dut->io_w_in_3_12 = (int)wVec[93];
  dut->io_w_in_3_13 = (int)wVec[94];
  dut->io_w_in_3_14 = (int)wVec[95];
  dut->io_w_in_3_15 = (int)wVec[96];
  dut->io_w_in_3_16 = (int)wVec[97];
  dut->io_w_in_3_17 = (int)wVec[98];
  dut->io_w_in_3_18 = (int)wVec[99];
  dut->io_w_in_3_19 = (int)wVec[100];
  dut->io_w_in_3_20 = (int)wVec[101];
  dut->io_w_in_3_21 = (int)wVec[102];
  dut->io_w_in_3_22 = (int)wVec[103];
  dut->io_w_in_3_23 = (int)wVec[104];
  dut->io_w_in_3_24 = (int)wVec[105];
  dut->io_w_in_3_25 = (int)wVec[106];
  dut->io_w_in_3_26 = (int)wVec[107];
  ...
  std::cout << "[case4] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
