...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case2";
  ...
  if ((int)wVec.size() != (int)18) {
    std::cerr << "weight length mismatch vs pin count: " << wVec.size() << " vs " << 18 << "\n";
    return 1;
  }
  ...
  std::cout << "[case2] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
