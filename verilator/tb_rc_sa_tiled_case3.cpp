...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case3";
  ...
  if ((int)inVec.size() != (int)50) {
    std::cerr << "input length mismatch vs pin count: " << inVec.size() << " vs " << 50 << "\n";
    return 1;
  }
  ...
  std::cout << "[case3] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
