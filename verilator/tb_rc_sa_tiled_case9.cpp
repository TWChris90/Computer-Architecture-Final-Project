...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case9";
  ...
  if ((int)wVec.size() != (int)36) {
    std::cerr << "weight length mismatch vs pin count: " << wVec.size() << " vs " << 36 << "\n";
    return 1;
  }
  ...
  std::cout << "[case9] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
