...
int main(int argc, char** argv) {
  ...
  const std::string dir = "../tests/vectors_sa_tiled/case7";
  ...
  if ((int)inVec.size() != (int)98) {
    std::cerr << "input length mismatch vs pin count: " << inVec.size() << " vs " << 98 << "\n";
    return 1;
  }
  ...
  dut->io_w_in_1_0 = (int)wVec[18];
  dut->io_w_in_1_1 = (int)wVec[19];
  dut->io_w_in_1_2 = (int)wVec[20];
  dut->io_w_in_1_3 = (int)wVec[21];
  dut->io_w_in_1_4 = (int)wVec[22];
  dut->io_w_in_1_5 = (int)wVec[23];
  dut->io_w_in_1_6 = (int)wVec[24];
  dut->io_w_in_1_7 = (int)wVec[25];
  dut->io_w_in_1_8 = (int)wVec[26];
  dut->io_w_in_1_9 = (int)wVec[27];
  dut->io_w_in_1_10 = (int)wVec[28];
  dut->io_w_in_1_11 = (int)wVec[29];
  dut->io_w_in_1_12 = (int)wVec[30];
  dut->io_w_in_1_13 = (int)wVec[31];
  dut->io_w_in_1_14 = (int)wVec[32];
  dut->io_w_in_1_15 = (int)wVec[33];
  dut->io_w_in_1_16 = (int)wVec[34];
  dut->io_w_in_1_17 = (int)wVec[35];
  dut->io_w_in_2_0 = (int)wVec[36];
  dut->io_w_in_2_1 = (int)wVec[37];
  dut->io_w_in_2_2 = (int)wVec[38];
  dut->io_w_in_2_3 = (int)wVec[39];
  dut->io_w_in_2_4 = (int)wVec[40];
  dut->io_w_in_2_5 = (int)wVec[41];
  dut->io_w_in_2_6 = (int)wVec[42];
  dut->io_w_in_2_7 = (int)wVec[43];
  dut->io_w_in_2_8 = (int)wVec[44];
  dut->io_w_in_2_9 = (int)wVec[45];
  dut->io_w_in_2_10 = (int)wVec[46];
  dut->io_w_in_2_11 = (int)wVec[47];
  dut->io_w_in_2_12 = (int)wVec[48];
  dut->io_w_in_2_13 = (int)wVec[49];
  dut->io_w_in_2_14 = (int)wVec[50];
  dut->io_w_in_2_15 = (int)wVec[51];
  dut->io_w_in_2_16 = (int)wVec[52];
  dut->io_w_in_2_17 = (int)wVec[53];
  ...
  std::cout << "[case7] wrote " << observed.size() << " values, cycles=" << cyc << "\n";
