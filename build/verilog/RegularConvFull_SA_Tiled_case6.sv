...
module Im2ColStreamerNCHW(
  ...
  assign io_a_out =
    running
      ? _GEN[({2'h0, kIdx / 4'h9} * 6'h6 + {2'h0, {1'h0, io_oh} + rem / 4'h3}) * 6'h6
...
module RegularConvFull_SA_Tiled(
  ...
  reg              compTileIdx;
  reg              compLastTile;
  wire [4:0]       _GEN = {1'h0, compTileIdx, 3'h0};
  ...
  wire [4:0]       _idx_T_4 = _GEN + 5'h4;
  wire [4:0]       _idx_T_5 = _GEN + 5'h5;
  wire [4:0]       _idx_T_6 = _GEN + 5'h6;
  wire [4:0]       _idx_T_7 = _GEN + 5'h7;
  wire [15:0][7:0] _GEN_1 =
    {{io_w_in_1_0},
     ...
     {io_w_in_1_1},
     {io_w_in_1_0}};
  wire [4:0]       _idx_T_9 = _GEN + 5'h1;
  wire [4:0]       _idx_T_10 = _GEN + 5'h2;
  wire [4:0]       _idx_T_11 = _GEN + 5'h3;
  wire [4:0]       _idx_T_12 = _GEN + 5'h4;
  wire [4:0]       _idx_T_13 = _GEN + 5'h5;
  wire [4:0]       _idx_T_14 = _GEN + 5'h6;
  wire [4:0]       _idx_T_15 = _GEN + 5'h7;
  wire [15:0][7:0] _GEN_2 =
    {{io_w_in_2_0},
     ...
     {io_w_in_2_1},
     {io_w_in_2_0}};
  wire [4:0]       _idx_T_17 = _GEN + 5'h1;
  wire [4:0]       _idx_T_18 = _GEN + 5'h2;
  wire [4:0]       _idx_T_19 = _GEN + 5'h3;
  wire [4:0]       _idx_T_20 = _GEN + 5'h4;
  wire [4:0]       _idx_T_21 = _GEN + 5'h5;
  wire [4:0]       _idx_T_22 = _GEN + 5'h6;
  wire [4:0]       _idx_T_23 = _GEN + 5'h7;
  reg  [2:0]       state;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_23 = capIdx == 3'h0;
      automatic logic _GEN_24 = capIdx == 3'h1;
      automatic logic _GEN_25 = capIdx == 3'h2;
      automatic logic _GEN_26 = capIdx == 3'h3;
      automatic logic _GEN_27 = capIdx == 3'h4;
      automatic logic _GEN_28 = capIdx == 3'h5;
      automatic logic _GEN_29 = capIdx == 3'h6;
      ...
      _GEN_15 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'h8);
      _GEN_16 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'h9);
      _GEN_17 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'hA);
      _GEN_18 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'hB);
      _GEN_19 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'hC);
      _GEN_20 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'hD);
      _GEN_21 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & posReg == 4'hE);
      _GEN_22 = _GEN_6 | ~(_GEN_5 & compValid & compLastTile & (&posReg));
      _GEN_30 = _GEN_5 & _im2col_io_valid;
      isLastGlobal = gkIdx == 4'h8;
      isTileEnd = (&capIdx) | isLastGlobal;
      _GEN_31 = _im2col_io_valid & isTileEnd;
      _GEN_32 = _GEN_5 & _GEN_31;
      _GEN_33 = state == 3'h3;
      _GEN_34 = state == 3'h4;
      if (_GEN_7) begin
      end
      ...
      doneReg <= ~_GEN_3 & (~(_GEN_4 | _GEN_5 | _GEN_33) & _GEN_34 | doneReg);
      if (_GEN_3) begin
        posReg <= 4'h0;
        if (io_start)
          state <= 3'h1;
        ...
        _GEN_35 = compValid & compLastTile;
        if (_GEN_4 | ~(_GEN_5 & _GEN_35) | (&posReg)) begin
        end
        else
          posReg <= posReg + 4'h1;
        if (_GEN_4) begin
      ...
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_24)) begin
      end
      else
        buf0_1 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_25)) begin
      end
      else
        buf0_2 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_26)) begin
      end
      else
        buf0_3 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_27)) begin
      end
      else
        buf0_4 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_28)) begin
      end
      else
        buf0_5 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_5 & _im2col_io_valid & ~bufSel & _GEN_29)) begin
      end
      else
      ...
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_23)) begin
      end
      else
        buf1_0 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_24)) begin
      end
      else
        buf1_1 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_25)) begin
      end
      else
        buf1_2 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_26)) begin
      end
      else
        buf1_3 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_27)) begin
      end
      else
        buf1_4 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_28)) begin
      end
      else
        buf1_5 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & _GEN_29)) begin
      end
      else
        buf1_6 <= _im2col_io_a_out;
      if (_GEN_6 | ~(_GEN_30 & bufSel & (&capIdx))) begin
      end
      else
        buf1_7 <= _im2col_io_a_out;
      bufSel <= ~_GEN_6 & (_GEN_32 ^ bufSel);
      tileIdx <= ~_GEN_6 & (_GEN_32 ? tileIdx - 1'h1 : tileIdx);
      compValid <= ~_GEN_6 & (_GEN_5 ? _GEN_31 : compValid);
      if (_GEN_6 | ~_GEN_32) begin
      end
      else begin
        compBufSel <= bufSel;
        compTileIdx <= tileIdx;
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_0_0 (_GEN < 5'h9 ? _GEN_0[{compTileIdx, 3'h0}] : 8'h0),
    ...
    .io_w_tile_0_4 (_idx_T_4 < 5'h9 ? _GEN_0[_idx_T_4[3:0]] : 8'h0),
    .io_w_tile_0_5 (_idx_T_5 < 5'h9 ? _GEN_0[_idx_T_5[3:0]] : 8'h0),
    .io_w_tile_0_6 (_idx_T_6 < 5'h9 ? _GEN_0[_idx_T_6[3:0]] : 8'h0),
    .io_w_tile_0_7 (_idx_T_7 < 5'h9 ? _GEN_0[_idx_T_7[3:0]] : 8'h0),
    .io_w_tile_1_0 (_GEN < 5'h9 ? _GEN_1[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_1_1 (_idx_T_9 < 5'h9 ? _GEN_1[_idx_T_9[3:0]] : 8'h0),
    .io_w_tile_1_2 (_idx_T_10 < 5'h9 ? _GEN_1[_idx_T_10[3:0]] : 8'h0),
    .io_w_tile_1_3 (_idx_T_11 < 5'h9 ? _GEN_1[_idx_T_11[3:0]] : 8'h0),
    .io_w_tile_1_4 (_idx_T_12 < 5'h9 ? _GEN_1[_idx_T_12[3:0]] : 8'h0),
    .io_w_tile_1_5 (_idx_T_13 < 5'h9 ? _GEN_1[_idx_T_13[3:0]] : 8'h0),
    .io_w_tile_1_6 (_idx_T_14 < 5'h9 ? _GEN_1[_idx_T_14[3:0]] : 8'h0),
    .io_w_tile_1_7 (_idx_T_15 < 5'h9 ? _GEN_1[_idx_T_15[3:0]] : 8'h0),
    .io_w_tile_2_0 (_GEN < 5'h9 ? _GEN_2[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_2_1 (_idx_T_17 < 5'h9 ? _GEN_2[_idx_T_17[3:0]] : 8'h0),
    .io_w_tile_2_2 (_idx_T_18 < 5'h9 ? _GEN_2[_idx_T_18[3:0]] : 8'h0),
    .io_w_tile_2_3 (_idx_T_19 < 5'h9 ? _GEN_2[_idx_T_19[3:0]] : 8'h0),
    .io_w_tile_2_4 (_idx_T_20 < 5'h9 ? _GEN_2[_idx_T_20[3:0]] : 8'h0),
    .io_w_tile_2_5 (_idx_T_21 < 5'h9 ? _GEN_2[_idx_T_21[3:0]] : 8'h0),
    .io_w_tile_2_6 (_idx_T_22 < 5'h9 ? _GEN_2[_idx_T_22[3:0]] : 8'h0),
    .io_w_tile_2_7 (_idx_T_23 < 5'h9 ? _GEN_2[_idx_T_23[3:0]] : 8'h0),
