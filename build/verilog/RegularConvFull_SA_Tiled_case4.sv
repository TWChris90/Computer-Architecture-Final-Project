...
module Im2ColStreamerNCHW(
  ...
  assign io_a_out =
    running
      ? _GEN[({2'h0, kIdx / 5'h9} * 7'h5 + {3'h0, {1'h0, io_oh} + rem[3:0] / 4'h3}) * 7'h5
...
module RegularConvFull_SA_Tiled(
  ...
  wire [31:0][7:0] _GEN_3 =
    {{io_w_in_3_0},
     ...
     {io_w_in_3_1},
     {io_w_in_3_0}};
  wire [5:0]       _idx_T_25 = _GEN + 6'h1;
  wire [5:0]       _idx_T_26 = _GEN + 6'h2;
  wire [5:0]       _idx_T_27 = _GEN + 6'h3;
  wire [5:0]       _idx_T_28 = _GEN + 6'h4;
  wire [5:0]       _idx_T_29 = _GEN + 6'h5;
  wire [5:0]       _idx_T_30 = _GEN + 6'h6;
  wire [5:0]       _idx_T_31 = _GEN + 6'h7;
  reg  [2:0]       state;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_18 = capIdx == 3'h0;
      automatic logic _GEN_19 = capIdx == 3'h1;
      automatic logic _GEN_20 = capIdx == 3'h2;
      automatic logic _GEN_21 = capIdx == 3'h3;
      automatic logic _GEN_22 = capIdx == 3'h4;
      automatic logic _GEN_23 = capIdx == 3'h5;
      automatic logic _GEN_24 = capIdx == 3'h6;
      ...
      _GEN_16 = posReg == 4'h8;
      _GEN_17 = _GEN_7 | ~(_GEN_6 & compValid & compLastTile & _GEN_16);
      _GEN_25 = _GEN_6 & _im2col_io_valid;
      isLastGlobal = gkIdx == 5'h1A;
      isTileEnd = (&capIdx) | isLastGlobal;
      _GEN_26 = _im2col_io_valid & isTileEnd;
      _GEN_27 = _GEN_6 & _GEN_26;
      _GEN_28 = state == 3'h3;
      _GEN_29 = state == 3'h4;
      if (_GEN_8) begin
      end
      ...
      doneReg <= ~_GEN_4 & (~(_GEN_5 | _GEN_6 | _GEN_28) & _GEN_29 | doneReg);
      if (_GEN_4) begin
        posReg <= 4'h0;
        if (io_start)
          state <= 3'h1;
        ...
        _GEN_30 = compValid & compLastTile;
        if (_GEN_5 | ~(_GEN_6 & _GEN_30) | _GEN_16) begin
        end
        else
          posReg <= posReg + 4'h1;
        if (_GEN_5) begin
      ...
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_18)) begin
      end
      else
        buf0_0 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_19)) begin
      end
      else
        buf0_1 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_20)) begin
      end
      else
        buf0_2 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_21)) begin
      end
      else
        buf0_3 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_22)) begin
      end
      else
        buf0_4 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_6 & _im2col_io_valid & ~bufSel & _GEN_23)) begin
      end
      else
      ...
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_18)) begin
      end
      else
        buf1_0 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_19)) begin
      end
      else
        buf1_1 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_20)) begin
      end
      else
        buf1_2 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_21)) begin
      end
      else
        buf1_3 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_22)) begin
      end
      else
        buf1_4 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_23)) begin
      end
      else
        buf1_5 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & _GEN_24)) begin
      end
      else
        buf1_6 <= _im2col_io_a_out;
      if (_GEN_7 | ~(_GEN_25 & bufSel & (&capIdx))) begin
      end
      else
        buf1_7 <= _im2col_io_a_out;
      bufSel <= ~_GEN_7 & (_GEN_27 ^ bufSel);
      compValid <= ~_GEN_7 & (_GEN_6 ? _GEN_26 : compValid);
      if (_GEN_7 | ~_GEN_27) begin
      end
      else begin
        compBufSel <= bufSel;
        compTileIdx <= tileIdx;
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_0_0 (_GEN < 6'h1B ? _GEN_0[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_0_1 (_idx_T_1 < 6'h1B ? _GEN_0[_idx_T_1[4:0]] : 8'h0),
    .io_w_tile_0_2 (_idx_T_2 < 6'h1B ? _GEN_0[_idx_T_2[4:0]] : 8'h0),
    .io_w_tile_0_3 (_idx_T_3 < 6'h1B ? _GEN_0[_idx_T_3[4:0]] : 8'h0),
    .io_w_tile_0_4 (_idx_T_4 < 6'h1B ? _GEN_0[_idx_T_4[4:0]] : 8'h0),
    .io_w_tile_0_5 (_idx_T_5 < 6'h1B ? _GEN_0[_idx_T_5[4:0]] : 8'h0),
    .io_w_tile_0_6 (_idx_T_6 < 6'h1B ? _GEN_0[_idx_T_6[4:0]] : 8'h0),
    .io_w_tile_0_7 (_idx_T_7 < 6'h1B ? _GEN_0[_idx_T_7[4:0]] : 8'h0),
    .io_w_tile_1_0 (_GEN < 6'h1B ? _GEN_1[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_1_1 (_idx_T_9 < 6'h1B ? _GEN_1[_idx_T_9[4:0]] : 8'h0),
    .io_w_tile_1_2 (_idx_T_10 < 6'h1B ? _GEN_1[_idx_T_10[4:0]] : 8'h0),
    .io_w_tile_1_3 (_idx_T_11 < 6'h1B ? _GEN_1[_idx_T_11[4:0]] : 8'h0),
    .io_w_tile_1_4 (_idx_T_12 < 6'h1B ? _GEN_1[_idx_T_12[4:0]] : 8'h0),
    .io_w_tile_1_5 (_idx_T_13 < 6'h1B ? _GEN_1[_idx_T_13[4:0]] : 8'h0),
    .io_w_tile_1_6 (_idx_T_14 < 6'h1B ? _GEN_1[_idx_T_14[4:0]] : 8'h0),
    .io_w_tile_1_7 (_idx_T_15 < 6'h1B ? _GEN_1[_idx_T_15[4:0]] : 8'h0),
    .io_w_tile_2_0 (_GEN < 6'h1B ? _GEN_2[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_2_1 (_idx_T_17 < 6'h1B ? _GEN_2[_idx_T_17[4:0]] : 8'h0),
    .io_w_tile_2_2 (_idx_T_18 < 6'h1B ? _GEN_2[_idx_T_18[4:0]] : 8'h0),
    .io_w_tile_2_3 (_idx_T_19 < 6'h1B ? _GEN_2[_idx_T_19[4:0]] : 8'h0),
    .io_w_tile_2_4 (_idx_T_20 < 6'h1B ? _GEN_2[_idx_T_20[4:0]] : 8'h0),
    .io_w_tile_2_5 (_idx_T_21 < 6'h1B ? _GEN_2[_idx_T_21[4:0]] : 8'h0),
    .io_w_tile_2_6 (_idx_T_22 < 6'h1B ? _GEN_2[_idx_T_22[4:0]] : 8'h0),
    .io_w_tile_2_7 (_idx_T_23 < 6'h1B ? _GEN_2[_idx_T_23[4:0]] : 8'h0),
    .io_w_tile_3_0 (_GEN < 6'h1B ? _GEN_3[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_3_1 (_idx_T_25 < 6'h1B ? _GEN_3[_idx_T_25[4:0]] : 8'h0),
    .io_w_tile_3_2 (_idx_T_26 < 6'h1B ? _GEN_3[_idx_T_26[4:0]] : 8'h0),
    .io_w_tile_3_3 (_idx_T_27 < 6'h1B ? _GEN_3[_idx_T_27[4:0]] : 8'h0),
    .io_w_tile_3_4 (_idx_T_28 < 6'h1B ? _GEN_3[_idx_T_28[4:0]] : 8'h0),
    .io_w_tile_3_5 (_idx_T_29 < 6'h1B ? _GEN_3[_idx_T_29[4:0]] : 8'h0),
    .io_w_tile_3_6 (_idx_T_30 < 6'h1B ? _GEN_3[_idx_T_30[4:0]] : 8'h0),
    .io_w_tile_3_7 (_idx_T_31 < 6'h1B ? _GEN_3[_idx_T_31[4:0]] : 8'h0),
