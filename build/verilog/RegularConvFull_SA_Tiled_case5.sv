...
module Im2ColStreamerNCHW(
  ...
  assign io_a_out =
    running
      ? _GEN[({2'h0, kIdx / 5'h9} * 7'h6 + {3'h0, {1'h0, io_oh} + rem[3:0] / 4'h3}) * 7'h6
...
module RegularConvFull_SA_Tiled(
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_3_0 (_GEN < 6'h12 ? _GEN_3[{compTileIdx, 3'h0}] : 8'h0),
    .io_w_tile_3_1 (_idx_T_25 < 6'h12 ? _GEN_3[_idx_T_25[4:0]] : 8'h0),
    .io_w_tile_3_2 (_idx_T_26 < 6'h12 ? _GEN_3[_idx_T_26[4:0]] : 8'h0),
    .io_w_tile_3_3 (_idx_T_27 < 6'h12 ? _GEN_3[_idx_T_27[4:0]] : 8'h0),
    .io_w_tile_3_4 (_idx_T_28 < 6'h12 ? _GEN_3[_idx_T_28[4:0]] : 8'h0),
    .io_w_tile_3_5 (_idx_T_29 < 6'h12 ? _GEN_3[_idx_T_29[4:0]] : 8'h0),
    .io_w_tile_3_6 (_idx_T_30 < 6'h12 ? _GEN_3[_idx_T_30[4:0]] : 8'h0),
    .io_w_tile_3_7 (_idx_T_31 < 6'h12 ? _GEN_3[_idx_T_31[4:0]] : 8'h0),
