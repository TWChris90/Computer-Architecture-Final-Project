...
module Im2ColStreamerNCHW(
  ...
  assign io_a_out =
    running
      ? _GEN[{{cIdx[0], 3'h0} + {1'h0, io_oh} + rem[3:0] / 4'h3, 3'h0}
...
module SystolicArrayMatVecFixed(
  ...
  PEFixed pe_39 (
    ...
    .io_psum_out (_pe_39_io_psum_out)
  );
  PEFixed pe_40 (
    .io_a_in     (io_a_in_6_4),
    .io_b_in     (io_b_in_4),
    .io_psum_in  (_pe_39_io_psum_out),
...
module RegularConvFull_SA_Tiled(
  ...
  reg  [1:0]       compTileIdx;
  reg              compLastTile;
  wire [4:0]       idx = {3'h0, compTileIdx} * 5'h6;
  wire [31:0][7:0] _GEN =
    {{io_w_in_0_0},
     {io_w_in_0_0},
     {io_w_in_0_0},
     ...
     {io_w_in_0_1},
     {io_w_in_0_0}};
  wire [4:0]       _idx_T_1 = idx + 5'h1;
  wire [4:0]       _idx_T_2 = idx + 5'h2;
  wire [4:0]       _idx_T_3 = idx + 5'h3;
  wire [4:0]       _idx_T_4 = idx + 5'h4;
  wire [4:0]       _idx_T_5 = idx + 5'h5;
  wire [31:0][7:0] _GEN_0 =
    {{io_w_in_1_0},
     ...
     {io_w_in_1_1},
     {io_w_in_1_0}};
  wire [4:0]       _idx_T_7 = idx + 5'h1;
  wire [4:0]       _idx_T_8 = idx + 5'h2;
  wire [4:0]       _idx_T_9 = idx + 5'h3;
  wire [4:0]       _idx_T_10 = idx + 5'h4;
  wire [4:0]       _idx_T_11 = idx + 5'h5;
  wire [31:0][7:0] _GEN_1 =
    {{io_w_in_2_0},
     ...
     {io_w_in_2_1},
     {io_w_in_2_0}};
  wire [4:0]       _idx_T_13 = idx + 5'h1;
  wire [4:0]       _idx_T_14 = idx + 5'h2;
  wire [4:0]       _idx_T_15 = idx + 5'h3;
  wire [4:0]       _idx_T_16 = idx + 5'h4;
  wire [4:0]       _idx_T_17 = idx + 5'h5;
  wire [31:0][7:0] _GEN_2 =
    {{io_w_in_3_0},
     ...
     {io_w_in_3_1},
     {io_w_in_3_0}};
  wire [4:0]       _idx_T_19 = idx + 5'h1;
  wire [4:0]       _idx_T_20 = idx + 5'h2;
  wire [4:0]       _idx_T_21 = idx + 5'h3;
  wire [4:0]       _idx_T_22 = idx + 5'h4;
  wire [4:0]       _idx_T_23 = idx + 5'h5;
  wire [31:0][7:0] _GEN_3 =
    {{io_w_in_4_0},
     ...
     {io_w_in_4_1},
     {io_w_in_4_0}};
  wire [4:0]       _idx_T_25 = idx + 5'h1;
  wire [4:0]       _idx_T_26 = idx + 5'h2;
  wire [4:0]       _idx_T_27 = idx + 5'h3;
  wire [4:0]       _idx_T_28 = idx + 5'h4;
  wire [4:0]       _idx_T_29 = idx + 5'h5;
  wire [31:0][7:0] _GEN_4 =
    {{io_w_in_5_0},
     ...
     {io_w_in_5_1},
     {io_w_in_5_0}};
  wire [4:0]       _idx_T_31 = idx + 5'h1;
  wire [4:0]       _idx_T_32 = idx + 5'h2;
  wire [4:0]       _idx_T_33 = idx + 5'h3;
  wire [4:0]       _idx_T_34 = idx + 5'h4;
  wire [4:0]       _idx_T_35 = idx + 5'h5;
  wire [31:0][7:0] _GEN_5 =
    {{io_w_in_6_0},
     ...
     {io_w_in_6_1},
     {io_w_in_6_0}};
  wire [4:0]       _idx_T_37 = idx + 5'h1;
  wire [4:0]       _idx_T_38 = idx + 5'h2;
  wire [4:0]       _idx_T_39 = idx + 5'h3;
  wire [4:0]       _idx_T_40 = idx + 5'h4;
  wire [4:0]       _idx_T_41 = idx + 5'h5;
  wire [31:0][7:0] _GEN_6 =
    {{io_w_in_7_0},
     ...
     {io_w_in_7_1},
     {io_w_in_7_0}};
  wire [4:0]       _idx_T_43 = idx + 5'h1;
  wire [4:0]       _idx_T_44 = idx + 5'h2;
  wire [4:0]       _idx_T_45 = idx + 5'h3;
  wire [4:0]       _idx_T_46 = idx + 5'h4;
  wire [4:0]       _idx_T_47 = idx + 5'h5;
  reg  [2:0]       state;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_48 = capIdx == 3'h0;
      automatic logic _GEN_49 = capIdx == 3'h1;
      automatic logic _GEN_50 = capIdx == 3'h2;
      automatic logic _GEN_51 = capIdx == 3'h3;
      automatic logic _GEN_52 = capIdx == 3'h4;
      automatic logic _GEN_53 = capIdx == 3'h5;
      ...
      _GEN_54 = _GEN_9 & _im2col_io_valid;
      isLastGlobal = gkIdx == 5'h11;
      isTileEnd = capIdx == 3'h5 | isLastGlobal;
      _GEN_55 = _im2col_io_valid & isTileEnd;
      _GEN_56 = _GEN_9 & _GEN_55;
      _GEN_57 = state == 3'h3;
      _GEN_58 = state == 3'h4;
      if (_GEN_11) begin
      end
      ...
      doneReg <= ~_GEN_7 & (~(_GEN_8 | _GEN_9 | _GEN_57) & _GEN_58 | doneReg);
      if (_GEN_7) begin
        posReg <= 6'h0;
        if (io_start)
          state <= 3'h1;
        ...
        _GEN_59 = compValid & compLastTile;
        if (_GEN_8 | ~(_GEN_9 & _GEN_59) | _GEN_46) begin
        end
        else
          posReg <= posReg + 6'h1;
        if (_GEN_8) begin
      ...
      if (_GEN_10 | ~(_GEN_9 & _im2col_io_valid & ~bufSel & _GEN_51)) begin
      end
      else
        buf0_3 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_9 & _im2col_io_valid & ~bufSel & _GEN_52)) begin
      end
      else
        buf0_4 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_9 & _im2col_io_valid & ~bufSel & _GEN_53)) begin
      end
      else
        buf0_5 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_48)) begin
      end
      else
        buf1_0 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_49)) begin
      end
      else
        buf1_1 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_50)) begin
      end
      else
        buf1_2 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_51)) begin
      end
      else
        buf1_3 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_52)) begin
      end
      else
        buf1_4 <= _im2col_io_a_out;
      if (_GEN_10 | ~(_GEN_54 & bufSel & _GEN_53)) begin
      end
      else
        buf1_5 <= _im2col_io_a_out;
      bufSel <= ~_GEN_10 & (_GEN_56 ^ bufSel);
      compValid <= ~_GEN_10 & (_GEN_9 ? _GEN_55 : compValid);
      if (_GEN_10 | ~_GEN_56) begin
      end
      else begin
        compBufSel <= bufSel;
        compTileIdx <= tileIdx;
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_0_0 (idx < 5'h12 ? _GEN[idx] : 8'h0),
    .io_w_tile_0_1 (_idx_T_1 < 5'h12 ? _GEN[_idx_T_1] : 8'h0),
    .io_w_tile_0_2 (_idx_T_2 < 5'h12 ? _GEN[_idx_T_2] : 8'h0),
    .io_w_tile_0_3 (_idx_T_3 < 5'h12 ? _GEN[_idx_T_3] : 8'h0),
    .io_w_tile_0_4 (_idx_T_4 < 5'h12 ? _GEN[_idx_T_4] : 8'h0),
    .io_w_tile_0_5 (_idx_T_5 < 5'h12 ? _GEN[_idx_T_5] : 8'h0),
    .io_w_tile_1_0 (idx < 5'h12 ? _GEN_0[idx] : 8'h0),
    .io_w_tile_1_1 (_idx_T_7 < 5'h12 ? _GEN_0[_idx_T_7] : 8'h0),
    .io_w_tile_1_2 (_idx_T_8 < 5'h12 ? _GEN_0[_idx_T_8] : 8'h0),
    .io_w_tile_1_3 (_idx_T_9 < 5'h12 ? _GEN_0[_idx_T_9] : 8'h0),
    .io_w_tile_1_4 (_idx_T_10 < 5'h12 ? _GEN_0[_idx_T_10] : 8'h0),
    .io_w_tile_1_5 (_idx_T_11 < 5'h12 ? _GEN_0[_idx_T_11] : 8'h0),
    .io_w_tile_2_0 (idx < 5'h12 ? _GEN_1[idx] : 8'h0),
    .io_w_tile_2_1 (_idx_T_13 < 5'h12 ? _GEN_1[_idx_T_13] : 8'h0),
    .io_w_tile_2_2 (_idx_T_14 < 5'h12 ? _GEN_1[_idx_T_14] : 8'h0),
    .io_w_tile_2_3 (_idx_T_15 < 5'h12 ? _GEN_1[_idx_T_15] : 8'h0),
    .io_w_tile_2_4 (_idx_T_16 < 5'h12 ? _GEN_1[_idx_T_16] : 8'h0),
    .io_w_tile_2_5 (_idx_T_17 < 5'h12 ? _GEN_1[_idx_T_17] : 8'h0),
    .io_w_tile_3_0 (idx < 5'h12 ? _GEN_2[idx] : 8'h0),
    .io_w_tile_3_1 (_idx_T_19 < 5'h12 ? _GEN_2[_idx_T_19] : 8'h0),
    .io_w_tile_3_2 (_idx_T_20 < 5'h12 ? _GEN_2[_idx_T_20] : 8'h0),
    .io_w_tile_3_3 (_idx_T_21 < 5'h12 ? _GEN_2[_idx_T_21] : 8'h0),
    .io_w_tile_3_4 (_idx_T_22 < 5'h12 ? _GEN_2[_idx_T_22] : 8'h0),
    .io_w_tile_3_5 (_idx_T_23 < 5'h12 ? _GEN_2[_idx_T_23] : 8'h0),
    .io_w_tile_4_0 (idx < 5'h12 ? _GEN_3[idx] : 8'h0),
    .io_w_tile_4_1 (_idx_T_25 < 5'h12 ? _GEN_3[_idx_T_25] : 8'h0),
    .io_w_tile_4_2 (_idx_T_26 < 5'h12 ? _GEN_3[_idx_T_26] : 8'h0),
    .io_w_tile_4_3 (_idx_T_27 < 5'h12 ? _GEN_3[_idx_T_27] : 8'h0),
    .io_w_tile_4_4 (_idx_T_28 < 5'h12 ? _GEN_3[_idx_T_28] : 8'h0),
    .io_w_tile_4_5 (_idx_T_29 < 5'h12 ? _GEN_3[_idx_T_29] : 8'h0),
    .io_w_tile_5_0 (idx < 5'h12 ? _GEN_4[idx] : 8'h0),
    .io_w_tile_5_1 (_idx_T_31 < 5'h12 ? _GEN_4[_idx_T_31] : 8'h0),
    .io_w_tile_5_2 (_idx_T_32 < 5'h12 ? _GEN_4[_idx_T_32] : 8'h0),
    .io_w_tile_5_3 (_idx_T_33 < 5'h12 ? _GEN_4[_idx_T_33] : 8'h0),
    .io_w_tile_5_4 (_idx_T_34 < 5'h12 ? _GEN_4[_idx_T_34] : 8'h0),
    .io_w_tile_5_5 (_idx_T_35 < 5'h12 ? _GEN_4[_idx_T_35] : 8'h0),
    .io_w_tile_6_0 (idx < 5'h12 ? _GEN_5[idx] : 8'h0),
    .io_w_tile_6_1 (_idx_T_37 < 5'h12 ? _GEN_5[_idx_T_37] : 8'h0),
    .io_w_tile_6_2 (_idx_T_38 < 5'h12 ? _GEN_5[_idx_T_38] : 8'h0),
    .io_w_tile_6_3 (_idx_T_39 < 5'h12 ? _GEN_5[_idx_T_39] : 8'h0),
    .io_w_tile_6_4 (_idx_T_40 < 5'h12 ? _GEN_5[_idx_T_40] : 8'h0),
    .io_w_tile_6_5 (_idx_T_41 < 5'h12 ? _GEN_5[_idx_T_41] : 8'h0),
    .io_w_tile_7_0 (idx < 5'h12 ? _GEN_6[idx] : 8'h0),
    .io_w_tile_7_1 (_idx_T_43 < 5'h12 ? _GEN_6[_idx_T_43] : 8'h0),
    .io_w_tile_7_2 (_idx_T_44 < 5'h12 ? _GEN_6[_idx_T_44] : 8'h0),
    .io_w_tile_7_3 (_idx_T_45 < 5'h12 ? _GEN_6[_idx_T_45] : 8'h0),
    .io_w_tile_7_4 (_idx_T_46 < 5'h12 ? _GEN_6[_idx_T_46] : 8'h0),
    .io_w_tile_7_5 (_idx_T_47 < 5'h12 ? _GEN_6[_idx_T_47] : 8'h0),
