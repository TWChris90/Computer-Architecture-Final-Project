...
module Im2ColStreamerNCHW(
  ...
  assign io_a_out =
    running
      ? _GEN[({3'h0, kIdx / 5'h9} * 8'h7 + {4'h0, {1'h0, io_oh} + rem[3:0] / 4'h3}) * 8'h7
...
module RegularConvFull_SA_Tiled(
  ...
  reg  [1:0]       compTileIdx;
  reg              compLastTile;
  wire [5:0]       idx = {4'h0, compTileIdx} * 6'h9;
  wire [31:0][7:0] _GEN =
    {{io_w_in_0_0},
     {io_w_in_0_0},
     {io_w_in_0_0},
     ...
     {io_w_in_0_1},
     {io_w_in_0_0}};
  wire [5:0]       _idx_T_1 = idx + 6'h1;
  wire [5:0]       _idx_T_2 = idx + 6'h2;
  wire [5:0]       _idx_T_3 = idx + 6'h3;
  wire [5:0]       _idx_T_4 = idx + 6'h4;
  wire [5:0]       _idx_T_5 = idx + 6'h5;
  wire [5:0]       _idx_T_6 = idx + 6'h6;
  wire [5:0]       _idx_T_7 = idx + 6'h7;
  wire [5:0]       _idx_T_8 = idx + 6'h8;
  wire [31:0][7:0] _GEN_0 =
    {{io_w_in_1_0},
     ...
     {io_w_in_1_1},
     {io_w_in_1_0}};
  wire [5:0]       _idx_T_10 = idx + 6'h1;
  wire [5:0]       _idx_T_11 = idx + 6'h2;
  wire [5:0]       _idx_T_12 = idx + 6'h3;
  wire [5:0]       _idx_T_13 = idx + 6'h4;
  wire [5:0]       _idx_T_14 = idx + 6'h5;
  wire [5:0]       _idx_T_15 = idx + 6'h6;
  wire [5:0]       _idx_T_16 = idx + 6'h7;
  wire [5:0]       _idx_T_17 = idx + 6'h8;
  reg  [2:0]       state;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_31 = capIdx == 4'h0;
      automatic logic _GEN_32 = capIdx == 4'h1;
      automatic logic _GEN_33 = capIdx == 4'h2;
      automatic logic _GEN_34 = capIdx == 4'h3;
      automatic logic _GEN_35 = capIdx == 4'h4;
      automatic logic _GEN_36 = capIdx == 4'h5;
      automatic logic _GEN_37 = capIdx == 4'h6;
      automatic logic _GEN_38 = capIdx == 4'h7;
      automatic logic _GEN_39 = capIdx == 4'h8;
      ...
      _GEN_3 = state == 3'h2;
      _GEN_5 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h0);
      _GEN_6 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h1);
      _GEN_7 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h2);
      _GEN_8 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h3);
      _GEN_9 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h4);
      _GEN_10 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h5);
      _GEN_11 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h6);
      _GEN_12 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h7);
      _GEN_13 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h8);
      _GEN_14 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h9);
      _GEN_15 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hA);
      _GEN_16 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hB);
      _GEN_17 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hC);
      _GEN_18 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hD);
      _GEN_19 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hE);
      _GEN_20 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'hF);
      _GEN_21 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h10);
      _GEN_22 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h11);
      _GEN_23 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h12);
      _GEN_24 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h13);
      _GEN_25 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h14);
      _GEN_26 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h15);
      _GEN_27 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h16);
      _GEN_28 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & posReg == 5'h17);
      _GEN_29 = posReg == 5'h18;
      _GEN_30 = _GEN_4 | ~(_GEN_3 & compValid & compLastTile & _GEN_29);
      _GEN_40 = _GEN_3 & _im2col_io_valid;
      isLastGlobal = gkIdx == 5'h1A;
      isTileEnd = capIdx == 4'h8 | isLastGlobal;
      _GEN_41 = _im2col_io_valid & isTileEnd;
      _GEN_42 = _GEN_3 & _GEN_41;
      _GEN_43 = state == 3'h3;
      _GEN_44 = state == 3'h4;
      if (_GEN_5) begin
      end
      ...
      doneReg <= ~_GEN_1 & (~(_GEN_2 | _GEN_3 | _GEN_43) & _GEN_44 | doneReg);
      if (_GEN_1) begin
        posReg <= 5'h0;
        if (io_start)
          state <= 3'h1;
        ...
        if (_GEN_2 | ~(_GEN_3 & _GEN_45) | _GEN_29) begin
        end
        else
          posReg <= posReg + 5'h1;
        if (_GEN_2) begin
      ...
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_31)) begin
      end
      else
        buf0_0 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_32)) begin
      end
      else
        buf0_1 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_33)) begin
      end
      else
        buf0_2 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_34)) begin
      end
      else
        buf0_3 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_35)) begin
      end
      else
        buf0_4 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_36)) begin
      end
      else
        buf0_5 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_37)) begin
      end
      else
        buf0_6 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_38)) begin
      end
      else
        buf0_7 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_3 & _im2col_io_valid & ~bufSel & _GEN_39)) begin
      end
      else
        buf0_8 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_31)) begin
      end
      else
        buf1_0 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_32)) begin
      end
      else
        buf1_1 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_33)) begin
      end
      else
        buf1_2 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_34)) begin
      end
      else
        buf1_3 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_35)) begin
      end
      else
        buf1_4 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_36)) begin
      end
      else
        buf1_5 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_37)) begin
      end
      else
        buf1_6 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_38)) begin
      end
      else
        buf1_7 <= _im2col_io_a_out;
      if (_GEN_4 | ~(_GEN_40 & bufSel & _GEN_39)) begin
      end
      else
        buf1_8 <= _im2col_io_a_out;
      bufSel <= ~_GEN_4 & (_GEN_42 ^ bufSel);
      compValid <= ~_GEN_4 & (_GEN_3 ? _GEN_41 : compValid);
      if (_GEN_4 | ~_GEN_42) begin
      end
      else begin
        compBufSel <= bufSel;
        compTileIdx <= tileIdx;
  ...
  Im2ColStreamerNCHW im2col (
    ...
    .io_in_98  (io_x_in_2_0),
    .io_in_99  (io_x_in_2_1),
    .io_in_100 (io_x_in_2_2),
    .io_in_101 (io_x_in_2_3),
    .io_in_102 (io_x_in_2_4),
    .io_in_103 (io_x_in_2_5),
    .io_in_104 (io_x_in_2_6),
    .io_in_105 (io_x_in_2_7),
    .io_in_106 (io_x_in_2_8),
    .io_in_107 (io_x_in_2_9),
    .io_in_108 (io_x_in_2_10),
    .io_in_109 (io_x_in_2_11),
    .io_in_110 (io_x_in_2_12),
    .io_in_111 (io_x_in_2_13),
    .io_in_112 (io_x_in_2_14),
    .io_in_113 (io_x_in_2_15),
    .io_in_114 (io_x_in_2_16),
    .io_in_115 (io_x_in_2_17),
    .io_in_116 (io_x_in_2_18),
    .io_in_117 (io_x_in_2_19),
    .io_in_118 (io_x_in_2_20),
    .io_in_119 (io_x_in_2_21),
    .io_in_120 (io_x_in_2_22),
    .io_in_121 (io_x_in_2_23),
    .io_in_122 (io_x_in_2_24),
    .io_in_123 (io_x_in_2_25),
    .io_in_124 (io_x_in_2_26),
    .io_in_125 (io_x_in_2_27),
    .io_in_126 (io_x_in_2_28),
    .io_in_127 (io_x_in_2_29),
    .io_in_128 (io_x_in_2_30),
    .io_in_129 (io_x_in_2_31),
    .io_in_130 (io_x_in_2_32),
    .io_in_131 (io_x_in_2_33),
    .io_in_132 (io_x_in_2_34),
    .io_in_133 (io_x_in_2_35),
    .io_in_134 (io_x_in_2_36),
    .io_in_135 (io_x_in_2_37),
    .io_in_136 (io_x_in_2_38),
    .io_in_137 (io_x_in_2_39),
    .io_in_138 (io_x_in_2_40),
    .io_in_139 (io_x_in_2_41),
    .io_in_140 (io_x_in_2_42),
    .io_in_141 (io_x_in_2_43),
    .io_in_142 (io_x_in_2_44),
    .io_in_143 (io_x_in_2_45),
    .io_in_144 (io_x_in_2_46),
    .io_in_145 (io_x_in_2_47),
    .io_in_146 (io_x_in_2_48),
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_0_0 (idx < 6'h1B ? _GEN[idx[4:0]] : 8'h0),
    .io_w_tile_0_1 (_idx_T_1 < 6'h1B ? _GEN[_idx_T_1[4:0]] : 8'h0),
    .io_w_tile_0_2 (_idx_T_2 < 6'h1B ? _GEN[_idx_T_2[4:0]] : 8'h0),
    .io_w_tile_0_3 (_idx_T_3 < 6'h1B ? _GEN[_idx_T_3[4:0]] : 8'h0),
    .io_w_tile_0_4 (_idx_T_4 < 6'h1B ? _GEN[_idx_T_4[4:0]] : 8'h0),
    .io_w_tile_0_5 (_idx_T_5 < 6'h1B ? _GEN[_idx_T_5[4:0]] : 8'h0),
    .io_w_tile_0_6 (_idx_T_6 < 6'h1B ? _GEN[_idx_T_6[4:0]] : 8'h0),
    .io_w_tile_0_7 (_idx_T_7 < 6'h1B ? _GEN[_idx_T_7[4:0]] : 8'h0),
    .io_w_tile_0_8 (_idx_T_8 < 6'h1B ? _GEN[_idx_T_8[4:0]] : 8'h0),
    .io_w_tile_1_0 (idx < 6'h1B ? _GEN_0[idx[4:0]] : 8'h0),
    .io_w_tile_1_1 (_idx_T_10 < 6'h1B ? _GEN_0[_idx_T_10[4:0]] : 8'h0),
    .io_w_tile_1_2 (_idx_T_11 < 6'h1B ? _GEN_0[_idx_T_11[4:0]] : 8'h0),
    .io_w_tile_1_3 (_idx_T_12 < 6'h1B ? _GEN_0[_idx_T_12[4:0]] : 8'h0),
    .io_w_tile_1_4 (_idx_T_13 < 6'h1B ? _GEN_0[_idx_T_13[4:0]] : 8'h0),
    .io_w_tile_1_5 (_idx_T_14 < 6'h1B ? _GEN_0[_idx_T_14[4:0]] : 8'h0),
    .io_w_tile_1_6 (_idx_T_15 < 6'h1B ? _GEN_0[_idx_T_15[4:0]] : 8'h0),
    .io_w_tile_1_7 (_idx_T_16 < 6'h1B ? _GEN_0[_idx_T_16[4:0]] : 8'h0),
    .io_w_tile_1_8 (_idx_T_17 < 6'h1B ? _GEN_0[_idx_T_17[4:0]] : 8'h0),
