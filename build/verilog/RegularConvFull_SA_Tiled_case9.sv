...
module RegularConvFull_SA_Tiled(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_4 = capIdx == 4'h0;
      automatic logic _GEN_5 = capIdx == 4'h1;
      automatic logic _GEN_6 = capIdx == 4'h2;
      automatic logic _GEN_7 = capIdx == 4'h3;
      automatic logic _GEN_8 = capIdx == 4'h4;
      automatic logic _GEN_9 = capIdx == 4'h5;
      automatic logic _GEN_10 = capIdx == 4'h6;
      automatic logic _GEN_11 = capIdx == 4'h7;
      automatic logic _GEN_12 = capIdx == 4'h8;
      ...
      _GEN_2 = state == 3'h2;
      _GEN_13 = _GEN_2 & _im2col_io_valid;
      isLastGlobal = gkIdx == 6'h23;
      isTileEnd = capIdx == 4'h8 | isLastGlobal;
      _GEN_14 = _im2col_io_valid & isTileEnd;
      _GEN_15 = _GEN_2 & _GEN_14;
      _GEN_16 = state == 3'h3;
      _GEN_17 = state == 3'h4;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h0)) begin
      end
      else
        yReg_0_0 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h1)) begin
      end
      else
        yReg_0_1 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h2)) begin
      end
      else
        yReg_0_2 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h3)) begin
      end
      else
        yReg_0_3 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h4)) begin
      end
      else
        yReg_0_4 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h5)) begin
      end
      else
        yReg_0_5 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h6)) begin
      end
      else
        yReg_0_6 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h7)) begin
      end
      else
        yReg_0_7 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h8)) begin
      end
      else
        yReg_0_8 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'h9)) begin
      end
      else
        yReg_0_9 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'hA)) begin
      end
      else
        yReg_0_10 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'hB)) begin
      end
      else
        yReg_0_11 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'hC)) begin
      end
      else
        yReg_0_12 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'hD)) begin
      end
      else
        yReg_0_13 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & posReg == 4'hE)) begin
      end
      else
        yReg_0_14 <= _core_io_psum_out_0;
      if (_GEN_3 | ~(_GEN_2 & compValid & compLastTile & (&posReg))) begin
      end
      else
        yReg_0_15 <= _core_io_psum_out_0;
      doneReg <= ~_GEN_0 & (~(_GEN_1 | _GEN_2 | _GEN_16) & _GEN_17 | doneReg);
      if (_GEN_0) begin
        posReg <= 4'h0;
        if (io_start)
          state <= 3'h1;
        ...
        _GEN_18 = compValid & compLastTile;
        if (_GEN_1 | ~(_GEN_2 & _GEN_18) | (&posReg)) begin
        end
        else
          posReg <= posReg + 4'h1;
        if (_GEN_1) begin
      ...
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_4)) begin
      end
      else
        buf0_0 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_5)) begin
      end
      else
        buf0_1 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_6)) begin
      end
      else
        buf0_2 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_7)) begin
      end
      else
        buf0_3 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_8)) begin
      end
      else
        buf0_4 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_9)) begin
      end
      else
        buf0_5 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_10)) begin
      end
      else
        buf0_6 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_11)) begin
      end
      else
        buf0_7 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_2 & _im2col_io_valid & ~bufSel & _GEN_12)) begin
      end
      else
        buf0_8 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_4)) begin
      end
      else
        buf1_0 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_5)) begin
      end
      else
        buf1_1 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_6)) begin
      end
      else
        buf1_2 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_7)) begin
      end
      else
        buf1_3 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_8)) begin
      end
      else
        buf1_4 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_9)) begin
      end
      else
        buf1_5 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_10)) begin
      end
      else
        buf1_6 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_11)) begin
      end
      else
        buf1_7 <= _im2col_io_a_out;
      if (_GEN_3 | ~(_GEN_13 & bufSel & _GEN_12)) begin
      end
      else
        buf1_8 <= _im2col_io_a_out;
      bufSel <= ~_GEN_3 & (_GEN_15 ^ bufSel);
      compValid <= ~_GEN_3 & (_GEN_2 ? _GEN_14 : compValid);
  ...
  RegularConvFull_SA_KTile core (
    ...
    .io_w_tile_0_0 (idx < 6'h24 ? _GEN[idx] : 8'h0),
    .io_w_tile_0_1 (_idx_T_1 < 6'h24 ? _GEN[_idx_T_1] : 8'h0),
    .io_w_tile_0_2 (_idx_T_2 < 6'h24 ? _GEN[_idx_T_2] : 8'h0),
    .io_w_tile_0_3 (_idx_T_3 < 6'h24 ? _GEN[_idx_T_3] : 8'h0),
    .io_w_tile_0_4 (_idx_T_4 < 6'h24 ? _GEN[_idx_T_4] : 8'h0),
    .io_w_tile_0_5 (_idx_T_5 < 6'h24 ? _GEN[_idx_T_5] : 8'h0),
    .io_w_tile_0_6 (_idx_T_6 < 6'h24 ? _GEN[_idx_T_6] : 8'h0),
    .io_w_tile_0_7 (_idx_T_7 < 6'h24 ? _GEN[_idx_T_7] : 8'h0),
    .io_w_tile_0_8 (_idx_T_8 < 6'h24 ? _GEN[_idx_T_8] : 8'h0),
